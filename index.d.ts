...
declare class Debugger {
  ...
  setLastRequest(type: RequestType, url: string, data: object, params: object): string;
}
...
declare class Request extends Routes {
  ...
  buildRequest(type: RequestType, urlParams: string[]): Promise<AxiosResponse>;
  ...
  route(name: string, routeParams: object, requestParams: object): Promise<AxiosResponse>;
...
declare class Crud extends Request {
  ...
  updateOrDestroy(method: RequestType, ...params: string[]): Promise<AxiosResponse>;
